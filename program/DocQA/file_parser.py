...
if __name__ == '__main__':
    txt_file_path = "D:/llm/llm_4_doc_qa/files/gdp.txt"
    content = FileParser(txt_file_path).parse()
    print(content)

    pdf_file_path = "D:/llm/llm_4_doc_qa/files/oppo_n3_flip.pdf"
    content = FileParser(pdf_file_path).parse()
    print(content)

    docx_file_path = "D:/llm/llm_4_doc_qa/files/haicaihua.docx"
